...
import propertiesPanelModule from '@/views/bpmn/lib'
// // import propertiesProviderModule from 'bpmn-js-properties-panel/lib/provider/camunda'

import propertiesProviderModule from '@/views/bpmn/lib/provider/camunda'
...
import customTranslate from '@/views/bpmn/customTranslate'
